...
<div class="navbar navbar-fixed-top custom-navbar" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="fuse-logo">
            <img src="{{asset('/logo.png')}}" alt="Article Picture">
        </div>
    </div>
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav-fuse navbar-nav navbar-right">
            ...
            <li style=" background: #E91E63; "><a onclick="document.getElementById('id01fuse').style.display='block'"
                    href="#" class="smoothScroll">Login</a></li>
...
<div id="id01fuse" class="modal">
    ...
    <?php include 'modal-login.blade.php';?>
</div>